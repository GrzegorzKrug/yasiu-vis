...
if __name__ == "__main__":
    ...
    model.add(keras.layers.Dense(30, activation="leaky_relu"))
    model.add(keras.layers.Dense(30, activation="leaky_relu"))
    model.add(keras.layers.Dense(30, activation="leaky_relu"))
    model.add(keras.layers.Dense(21, activation="leaky_relu"))
    ...
    optim = keras.optimizers.Adam(learning_rate=0.0004)
